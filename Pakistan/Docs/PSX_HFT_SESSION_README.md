...
**Date:** 2026-09-11 (rev. 2026-09-12 — see *Corrections* at the end) · **Scope:** queue-skew deploy decision, weighted-OBI investigation, tooling fixes, lead-lag screen build, universe expansion
...
1. **Deploy config changed QBPS_2 → QT_2t** (§TL;DR, §1). Decided on total PKR: 8,736,780 vs 8,278,591. The two are statistically indistinguishable on edge; the trade-off is now stated explicitly rather than presented as a clean win.

...
class MicrostructureMM:
    ...
    def quotes(self, bb, bq, ba, aq, pos, depth=None):
        ...
        # Use an optional research signal only for quote skew; all other L1 uses stay unchanged.
        spacing_imb = self.spacing_signal(bb, ba, imb) if hasattr(self, "spacing_signal") else imb
        ...
        if self.queue_skew_stairs or self.queue_skew_ticks != 0.0 \
            ...
            if (spacing_imb - 0.5) > self.queue_skew_thresh:
            ...
            elif (0.5 - spacing_imb) > self.queue_skew_thresh:

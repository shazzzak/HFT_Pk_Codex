...
def main():
    ...
    ckpt_path = RESULTS / "throttle_fh_full_CKPT.jsonl"
    ...
    if off_key is not None:
        ...
        print("\n=== NONE - config (PAIRED by day): positive => NONE wins (throttle hurts) ===")
    ...
    out = RESULTS / f"throttle_fh_full_{stamp}.csv"
    ...
    dout = RESULTS / f"throttle_fh_full_DAILY_{stamp}.csv"
    ...
    nout = RESULTS / f"throttle_fh_full_PERNAME_{stamp}.csv"

...
def main():
    ...
    ckpt_path = RESULTS / "taper_sweep_CKPT.jsonl"
    ...
    print(f"\nINVENTORY-TAPER -- quantity ramp on POV capacity (POV held constant) (winner frozen "
    ...
    out = RESULTS / f"taper_sweep_{stamp}.csv"

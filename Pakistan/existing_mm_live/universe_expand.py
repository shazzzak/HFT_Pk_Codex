...
NAMES = ['AGHA', 'AGP', 'AHCL', 'AICL', 'AIRLINK', 'AKBL', 'APL', 'ASL',
         ...
         'LUCK', 'MARI', 'MCB', 'MEBL', 'MLCF', 'MUGHAL',
...
def main():
    ...
    ckpt_path = RESULTS / "universe_expand_CKPT.jsonl"
    ...
    out = RESULTS / f"universe_expand_{stamp}.csv"
    ...
    dout = RESULTS / f"universe_expand_DAILY_{stamp}.parquet"
    ...
    nout = RESULTS / f"universe_expand_PERNAME_{stamp}.parquet"
